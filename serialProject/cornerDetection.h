...
#define THRESHOLD 50 		// Intensity value of a pixel to detect a possible corner ("pixel_p_intensity > comparisonPixelIntensity + THRESHOLD")
...
class cornerDetection {
  ...
  public:
    ...
    void showKeyPoints(Mat& image); //Function to draw circles in corrispondence of corners
};
